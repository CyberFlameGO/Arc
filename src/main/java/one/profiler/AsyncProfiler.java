 ...
 * async-one.profiler native library. This class is a singleton.
...
public class AsyncProfiler implements AsyncProfilerMXBean {
     ...
     * @throws IllegalStateException If one.profiler is already running
     */
    @Override
     ...
     *
     * @throws IllegalStateException If one.profiler is not running
     */
    @Override
    ...
    /**
     * Get one.profiler agent version, e.g. "1.0"
     *
